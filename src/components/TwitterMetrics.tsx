...
const AnimatedMetric = ({
  ...
  return <div className="bg-card border-border rounded-2xl p-4 hover:bg-accent/50 transition-all duration-300 hover:shadow-md hover:border-border/70">
      ...
      <Card className="bg-card border-border h-full shadow-lg rounded-3xl">
        <div className="p-6">
          ...
          <div className="grid grid-cols-3 gap-6 w-full">
            {metricsData.map((metric, index) => <AnimatedMetric key={index} metric={metric} delay={index * 200} />)}
          </div>
        </div>
      </Card>
    </div>;
